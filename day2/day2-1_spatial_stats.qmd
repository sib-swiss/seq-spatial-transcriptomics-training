...
We order them and plot the gene expression top 3 genes with the `plotSpatialFeature` function from the `Voyager` package.
...
First we will load subsetted slides from 4 samples in the dataset (2 healthy slides and 2 cancerous slides). 
