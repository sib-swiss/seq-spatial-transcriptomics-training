...
-   Understand the structure of a `SpatialExperiment` objeict.
...
> If we do have space ranger kind of output: "Have a look at the subdirectories of the downloaded data. The subdirectories structure corresponds to standardized Space Ranger output files"
...
plotVisium(spe, 
           ...
           point_size = 1,
           point_shape = 22)
plotVisium(spe, annotate = "sum", zoom = TRUE, spots = FALSE)
```
::: callout-important
## Exercise
