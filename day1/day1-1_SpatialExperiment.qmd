...
The dataset contains normal adjacent tissue (NAT) and 7colorectal carcinoma (CRC) from 5 patients.  
...
saveHDF5SummarizedExperiment(spe, dir="results/day1", prefix="01.1_spe", replace=TRUE,
