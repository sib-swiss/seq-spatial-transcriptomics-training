...
The `scuttle::computePooledFactors()` implements the strategy introduced by [Lun et al.](https://link.springer.com/article/10.1186/s13059-016-0947-7) to account for compositional biases (which can introduce spurious differences between cells) during normalization. 
